...
filter_dm = re.compile(
    r'^' + re.escape(cfg['bot']['command_prefix']) + r'(ajuda|semanais|weeklies|tempo|time|desistir|forfeit|video|gravacao|vod|entradas|inscricoes|entries|criarsemanal|weeklycreate|testarsemanal|weeklytest|encerrarsemanal|weeklyclose|alterarsemanal|weeklyupdate|alterarentrada|entryupdate|comentario|comment).*$'
)
